...
namespace RAWSimO.Core.Control.Defaults.PodStorage
{
    ...
    /// </summary>
    public class TestPodStorageManagers : PodStorageManager
    {
        /// <summary>
        /// Creates a new instance of this manager.
        /// </summary>
        /// <param name="instance">The instance this manager belongs to.</param>
        public TestPodStorageManagers(Instance instance) : base(instance) { _config = Instance.ControllerConfig.PodStorageConfig as TestPodStorageConfiguration; }

        private TestPodStorageConfiguration _config;

        /// <summary>
        /// Returns a suitable storage location for the given pod.
        /// </summary>
        /// <param name="pod">The pod to fetch a storage location for.</pa ram>
