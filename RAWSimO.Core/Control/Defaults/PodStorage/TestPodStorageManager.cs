...
namespace RAWSimO.Core.Control.Defaults.PodStorage
{
    ...
    /// </summary>
    public class TestPodStorageManager : PodStorageManager
    {
        /// <summary>
        /// Creates a new instance of this manager.
        /// </summary>
        /// <param name="instance">The instance this manager belongs to.</param>
        public TestPodStorageManager(Instance instance) : base(instance) { _config = Instance.ControllerConfig.PodStorageConfig as TestPodStorageConfiguration; }
